...
cat <<'EOF' > ~/troubleshooting/solution-3/provider.tf
terraform {
  required_providers {
    docker = {
...
cat <<'EOF' > ~/troubleshooting/solution-3/variables.tf
...
cat <<'EOF' > ~/troubleshooting/solution-3/main.tf
...
cat <<'EOF' > ~/troubleshooting/solution-3/locals.tf
locals {
