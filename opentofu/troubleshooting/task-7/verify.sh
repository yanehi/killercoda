...
cat <<'EOF' > ~/troubleshooting/solution-7/provider.tf
terraform {
  required_providers {
    docker = {
...
cat <<'EOF' > ~/troubleshooting/solution-7/variables.tf
...
cat <<'EOF' > ~/troubleshooting/solution-7/main.tf
...
cat <<'EOF' > ~/troubleshooting/solution-7/locals.tf
locals {
