...
cat <<'EOF' > ~/troubleshooting/solution-5/provider.tf
terraform {
  required_providers {
    docker = {
...
cat <<'EOF' > ~/troubleshooting/solution-5/variables.tf
...
cat <<'EOF' > ~/troubleshooting/solution-5/main.tf
...
cat <<'EOF' > ~/troubleshooting/solution-5/locals.tf
locals {
...
cat <<'EOF' > ~/troubleshooting/solution-5/image.tf
...
cat <<'EOF' > ~/troubleshooting/solution-5/outputs.tf
