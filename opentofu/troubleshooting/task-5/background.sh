...
cat <<'EOF' > ~/troubleshooting/task-5/variables.tf
...
cat <<'EOF' > ~/troubleshooting/task-5/main.tf
...
cat <<'EOF' > ~/troubleshooting/task-5/locals.tf
locals {
...
cat <<'EOF' > ~/troubleshooting/task-5/image.tf
...
cat <<'EOF' > ~/troubleshooting/task-5/outputs.tf
