...
cat <<'EOF' > ~/troubleshooting/solution-2/provider.tf
terraform {
  required_providers {
    docker = {
...
cat <<'EOF' > ~/troubleshooting/solution-2/variables.tf
...
cat <<'EOF' > ~/troubleshooting/solution-2/main.tf
...
cat <<'EOF' > ~/troubleshooting/solution-2/locals.tf
locals {
