...
cat <<'EOF' > ~/troubleshooting/task-4/variables.tf
...
cat <<'EOF' > ~/troubleshooting/task-4/main.tf
...
cat <<'EOF' > ~/troubleshooting/task-4/locals.tf
locals {
...
cat <<'EOF' > ~/troubleshooting/task-4/image.tf
...
cat <<'EOF' > ~/troubleshooting/task-4/outputs.tf
